        ...
        <div class="page-holder align-items-center py-4 bg-gray-100 vh-100">
            ...
            <div class="container">
                ...
                <div class="row mt-5 mb-3">
                    <!-- <button class="btn btn-primary" type="button" id="guardar-nuevo" v-on:click="editar()">Test</button> -->
                    <RouterLink to="/panel">
                        <button class="btn btn-primary" type="button" id="guardar-nuevo" v-on:click="editar()">GUARDAR</button>
                    </RouterLink>
